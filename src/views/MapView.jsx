...
const MapView = () => {
  ...
  return (
    <>
<div className='flex flex-col sm:flex-row justify-between items-center bg-slate-500'>
  ...
  <div className='flex justify-end mt-3 sm:border-b pb-7 sm:px-4 px-2 border-gray-500 gap-4 w-full'>
    {/* ... Your other header elements ... */}
  </div>
  <div className="flex flex-col sm:hidden mt-3 space-y-2 w-full">
    {/* Mobile menu items */}
    {isSignedIn ? (
      <>
        <SignedInHeader />
