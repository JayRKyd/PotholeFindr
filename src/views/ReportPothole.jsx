...
const ReportPothole = () => {
  ...
  <>
            ...
            <div className='flex flex-1 mx-auto flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 bg-gray-500 rounded-lg FixWidth'>
            {isSubmitted ? (
        <p className='text-green-400 text-xl mb-4 font-semibold'>
          Success! Thanks for your report!
        </p>
      ) : (
        <form onSubmit={handleFormSubmit} className='bg-white flex flex-col rounded-lg p-4 sm:w-1/2 mx-auto'>
  ...
  <button
    type='submit'
    className='bg-blue-500 text-white py-2 px-4 rounded-lg font-bold hover:bg-blue-700 transition w-full sm:w-auto'
  >
    Submit
  </button>
</form>
